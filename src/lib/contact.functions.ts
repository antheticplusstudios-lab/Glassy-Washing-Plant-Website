...
/** Admin-only: send a real Resend test message to the temporary test inbox. */
export const sendResendTestEmail = createServerFn({ method: "POST" })
  ...
  .handler(async ({ context }) => {
    ...
    return sendEmail({
      to: "antheticplusstudios@gmail.com",
      from: "Glassy Washing Plant <onboarding@resend.dev>",
      subject: "Glassy Washing Plant — Resend test",
      text: "This is a Resend delivery test from the Glassy Washing Plant admin panel.",
      html: "<p>This is a <strong>Resend delivery test</strong> from the Glassy Washing Plant admin panel.</p>",
    });
  });
