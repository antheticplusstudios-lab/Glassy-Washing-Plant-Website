...
export function emailShell(title: string, bodyHtml: string): string {
  return `<!doctype html><html><body style="margin:0;background:#ffffff;font-family:Helvetica,Arial,sans-serif;color:#10202e">
  <div style="max-width:560px;margin:0 auto;padding:32px 24px">
    <p style="margin:0 0 8px;font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:#5b7a93">Glassy Washing Plant</p>
    <h1 style="margin:0 0 20px;font-size:22px;line-height:1.25">${escapeHtml(title)}</h1>
    ${bodyHtml}
    <hr style="margin:28px 0 12px;border:none;border-top:1px solid #c9e0f0" />
    <p style="margin:0;font-size:11px;color:#5b7a93">Glassy Washing Plant · House 13, Wazuddin Rd, Vatara, Dhaka 1212</p>
  </div></body></html>`;
}
