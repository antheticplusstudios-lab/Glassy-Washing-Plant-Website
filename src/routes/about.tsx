...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "The Factory — Inside Our Dhaka Wash House | Glassy" },
      {
        name: "description",
        content:
          "Meet Glassy Washing Plant in Vatara, Dhaka: 11,500 square feet, 120+ operators and commercial garment washing, dyeing and finishing capacity.",
      },
